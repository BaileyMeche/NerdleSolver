...
def filter_data():
    # Assuming the request JSON body correctly maps to the function's parameters
    data = request.get_json()
    df = pd.DataFrame(data['df'])  # Convert the incoming JSON data to DataFrame
    Green = data['Green']
    Purple = data['Purple']
    Black = data['Black']

    # Get the filtered data as JSON
    filtered_json = filter_dataframe(df, Green, Purple, Black)
